    ...
    <div class="popup-overlay">
      <div class="greatwork-popup">
        <div class="gw-btn-row">
          <img src="../assets/images/common/icon-play.svg" class="gw-btn play" onclick="goToGame()">
          <img src="../assets/images/common/reset.svg" class="gw-btn reset" onclick="restartStep()">
          <img src="../assets/images/common/next.svg" class="gw-btn next" onclick="goNextStep()">
        </div>
